      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md w-full">
        <div className="bg-white py-8 px-4 sm:px-8 shadow-lg rounded-xl sm:rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#2563EB] to-[#4F46E5] hover:from-[#1E40AF] hover:to-[#3730A3] text-white font-medium py-3 px-4 rounded-lg transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:outline-none"
            >
              Đăng nhập
            </button>
          </form>
          ...
          <div className="mt-8 text-center">
            <a
              href="#"
              className="text-sm text-[#2563EB] hover:text-[#4F46E5] transition-colors"
            >
