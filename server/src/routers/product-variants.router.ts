...
router.post('/', authorization([RoleManager.manager, RoleManager.staff]), variantsManagers.createVariant);            // Tạo biến thể sản phẩm mới
router.put('/:id', authorization([RoleManager.manager, RoleManager.staff]), variantsManagers.updateVariant);          // Cập nhật biến thể sản phẩm
